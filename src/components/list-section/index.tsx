...
const ListSection = () => (
  <section className={tw(`lg:py-28 pt-28 overflow-hidden`)}>
    <div className={tw(`max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 bg-white`)} id="process">
      ...
      <div className={tw(`flex  flex-wrap -mx-8 items-center`)}>
        ...
        <div className={tw(`w-1/2 flex justify-center items-center px-8 mx-auto mt-10 lg:mt-0`)}>
