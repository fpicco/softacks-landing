        ...
        <div className={tw(`flex flex-col md:flex-row justify-center items-center gap-x-20 -mt-5`)}>
          <p className={tw(`container mx-auto xl:px-40`)}>
            <span className={tw(`block`)}>
              ...
              is not only easy to use but also helps businesses run more efficiently. Our team of experienced developers
              can create custom solutions that are tailored to your specific needs.
            </span>
            ...
            <span className={tw(`block mt-1`)}>
              If you are looking for a company that can provide you with custom software solutions, then look no further
              than Softacks. Contact us today to learn more about what we can do for you.
            </span>
          </p>
        </div>
      </div>
