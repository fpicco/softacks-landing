  ...
  <Page>
    <div className={tw(`container mx-auto my-10`)}>
      <div className={tw(`text-center`)}>
        <h1 className={tw(`text-2xl`)}>Privacy Policy</h1>
      ...
      <ul>
        <li className={tw(`list-disc ml-10`)}>Phone Numbers</li>
        <li className={tw(`list-disc ml-10`)}>Email Addresses</li>
        <li className={tw(`list-disc ml-10`)}>Billing Addresses</li>
        <li className={tw(`list-disc ml-10`)}>Debit/credit card numbers</li>
      </ul>
      ...
      <ul>
        ...
        <li className={tw(`list-disc ml-10`)}>To process transactions</li>
        <li className={tw(`list-disc ml-10`)}>To administer a contest, promotion, survey or other site feature</li>
        <li className={tw(`list-disc ml-10`)}>To send periodic emails</li>
      </ul>
      ...
      <p>
        ...
        websites you have indicated. You can control how much of your information social media websites make public by
      ...
      <p>
        ...
        purchase through the website. We will likely share your personal information, and possibly some non-personal
      ...
      <p>
        ...
        reporting for us and our advertisers.may also disclose personal and non-personal information about you to
      ...
      <p>
        ...
        for us to locate. Promptly after receiving your request, all personal information stored in databases we
        actively use, and other readily searchable media will be updated, corrected, changed or deleted, as appropriate,
        as soon as and to the extent reasonably and technically practicable.
      </p>
      <p>
        If you are an end user and wish to update, delete, or receive any information we have about you, you may do so
      ...
      <p>
        You may contact us in order to (1) update or correct your information, (2) change your preferences with respect
      ...
      <p>
        This Privacy Policy is governed by the laws of United States without regard to its conflict of laws provision.
      ...
      <p>
        The laws of United States, excluding its conflicts of law rules, shall govern this Agreement and your use of the
      ...
      <h1 className={tw(`text-lg mt-10 underline decoration-primary decoration-2 underline-offset-2`)}>Your Consent</h1>
      <p>
      ...
      <p>
        ...
        platform, is subject to that website&apos;s own rules and policies. Such third parties may use their own cookies
      ...
      <p>
        I n respect to any cr edit card or other payment processing details you have provided us, we commit that this
      ...
      <p>
        ...
        Us with Personal Data, please contact Us. If We become aware that We have collected Personal Data from anyone
