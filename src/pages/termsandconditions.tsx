  ...
  <Page>
    <div className={tw(`container mx-auto my-10`)}>
      <div className={tw(`text-center`)}>
        <h1 className={tw(`text-2xl`)}>Terms & Conditions</h1>
      ...
      <p>
        We&apos;ve updated our Terms & Conditions to provide you with complete transparency into what is being set when
      ...
      <p>
        Upon termination of this Agreement, you shall cease all use of the website and delete all copies of the website
        from your computer.
      </p>
      <p>
      ...
      <p>
        ...
        the material that is claimed to be infringing; (c) your contact information, including your address, telephone
      ...
      <h1 className={tw(`text-lg mt-10 underline decoration-secondary decoration-2 underline-offset-2`)}>Waiver</h1>
      <p>
      ...
      <p>
        ...
        <a
          ...
          data-cfemail="e38a8d858ca3818f868d808f8c9687cd808c8ecd"
        >
          [email&#160;protected]
        </a>
      ...
      <p>
        ...
        court of competent jurisdiction, as necessary to protect the party&apos;s rights or property pending the
      ...
      <p>
        Additional terms and conditions may apply to purchases of goods or services on or through the Services, which
      ...
      <p>
        ...
        the order has been confirmed and your credit card charged. If your credit card has already been charged for the
        purchase and your order is canceled, we shall immediately issue a credit to your credit card account or other
